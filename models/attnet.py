...
def AttNet(input_shape, n_classes):
  ...
  conv8 = Conv2D(n_classes, (1, 1), activation='relu', padding='same')(up4)
  # conv8 = core.Reshape((input_shape[0] * input_shape[1], n_classes))(conv8)
  ############
